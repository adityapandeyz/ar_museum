...
class ArSaturnMapScreen extends StatefulWidget {
  const ArSaturnMapScreen({super.key});

  @override
  State<ArSaturnMapScreen> createState() => _ArSaturnMapScreenState();
}

class _ArSaturnMapScreenState extends State<ArSaturnMapScreen> {
  ...
  displayEarthMapSphere(ArCoreController coreController) async {
    final ByteData earthTextureBytes =
        await rootBundle.load("assets/2k_saturn.jpg");

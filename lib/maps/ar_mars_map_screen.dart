...
class ArMarsMapScreen extends StatefulWidget {
  const ArMarsMapScreen({super.key});

  @override
  State<ArMarsMapScreen> createState() => _ArMarsMapScreenState();
}

class _ArMarsMapScreenState extends State<ArMarsMapScreen> {
  ...
  displayEarthMapSphere(ArCoreController coreController) async {
    final ByteData earthTextureBytes =
        await rootBundle.load("assets/2k_mars.jpg");

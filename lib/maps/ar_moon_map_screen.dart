...
class ArMoonMapScreen extends StatefulWidget {
  const ArMoonMapScreen({super.key});

  @override
  State<ArMoonMapScreen> createState() => _ArMoonMapScreenState();
}

class _ArMoonMapScreenState extends State<ArMoonMapScreen> {
  ...
  displayEarthMapSphere(ArCoreController coreController) async {
    final ByteData earthTextureBytes =
        await rootBundle.load("assets/2k_moon.jpg");

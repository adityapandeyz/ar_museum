...
class ArNeptuneMapScreen extends StatefulWidget {
  const ArNeptuneMapScreen({super.key});

  @override
  State<ArNeptuneMapScreen> createState() => _ArNeptuneMapScreenState();
}

class _ArNeptuneMapScreenState extends State<ArNeptuneMapScreen> {
  ...
  displayEarthMapSphere(ArCoreController coreController) async {
    final ByteData earthTextureBytes =
        await rootBundle.load("assets/2k_neptune.jpg");

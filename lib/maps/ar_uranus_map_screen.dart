...
class ArUranusMapScreen extends StatefulWidget {
  const ArUranusMapScreen({super.key});

  @override
  State<ArUranusMapScreen> createState() => _ArUranusMapScreenState();
}

class _ArUranusMapScreenState extends State<ArUranusMapScreen> {
  ...
  displayEarthMapSphere(ArCoreController coreController) async {
    final ByteData earthTextureBytes =
        await rootBundle.load("assets/2k_uranus.jpg");

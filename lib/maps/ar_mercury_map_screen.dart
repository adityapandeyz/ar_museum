...
class ArMercuryMapScreen extends StatefulWidget {
  const ArMercuryMapScreen({super.key});

  @override
  State<ArMercuryMapScreen> createState() => _ArMercuryMapScreenState();
}

class _ArMercuryMapScreenState extends State<ArMercuryMapScreen> {
  ...
  displayEarthMapSphere(ArCoreController coreController) async {
    final ByteData earthTextureBytes =
        await rootBundle.load("assets/2k_mercury.jpg");
